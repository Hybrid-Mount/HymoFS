...
/* Syscall number: 142 = SYS_reboot on aarch64; we kprobe __arm64_sys_reboot
 * (5.10 compatible). */
...
#define HYMO_IOC_LIST_RULES                                                    \
  _IOWR(HYMO_IOC_MAGIC, 7, struct hymo_syscall_list_arg)
...
#define HYMO_IOC_HIDE_OVERLAY_XATTRS                                           \
  _IOW(HYMO_IOC_MAGIC, 11, struct hymo_syscall_arg)
#define HYMO_IOC_ADD_MERGE_RULE                                                \
  _IOW(HYMO_IOC_MAGIC, 12, struct hymo_syscall_arg)
#define HYMO_IOC_SET_MIRROR_PATH                                               \
  _IOW(HYMO_IOC_MAGIC, 14, struct hymo_syscall_arg)
#define HYMO_IOC_ADD_SPOOF_KSTAT                                               \
  _IOW(HYMO_IOC_MAGIC, 15, struct hymo_spoof_kstat)
#define HYMO_IOC_UPDATE_SPOOF_KSTAT                                            \
  _IOW(HYMO_IOC_MAGIC, 16, struct hymo_spoof_kstat)
...
#define HYMO_IOC_SET_HIDE_UIDS                                                 \
  _IOW(HYMO_IOC_MAGIC, 21, struct hymo_uid_list_arg)
